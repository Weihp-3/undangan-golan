...
// COUNTDOWN TIMER LOGIC (Target: 30 Desember 2026 08:00 WIB)
...
function tambahKeKalender() {
    const title = encodeURIComponent("Pernikahan Tika & Tiko");
    const details = encodeURIComponent("Acara Pernikahan Tika Azkiya & Tiko Permana. Hatur nuhun kana kasumpingan sareng pidu'a restu ti sadayana.");
    const location = encodeURIComponent("Gedong Budaya Sabilulungan, Jl. Raya Soreang No. 104, Kab. Bandung");
    
    // Waktu UTC (30 Desember 2026 jam 08.00 WIB = 01.00 UTC)
    const startDate = "20261230T010000Z";
    const endDate = "20261230T060000Z";
...
function kirimRSVP(event) {
    ...
    showToast("Hatur nuhun " + nama + ", ucapan tos kintun!");
